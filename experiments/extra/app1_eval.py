...
guo_dir = serv_dir / 'guo_app1'
adathr_dir = serv_dir / 'ada_app1'
multi_dir = serv_dir / 'multi_app1'
niend_dir = serv_dir / 'niend_app1'
raw_dir = serv_dir / 'raw_app1'
...
def main(name: str):
    ...
    my = niend_dir / f'{name}.v3dpbd_app1.swc'
    ada = adathr_dir / f'{name}.v3dpbd_app1.swc'
    mul = multi_dir / f'{name}.v3draw_app1.swc'
    guo = guo_dir / f'{name}.v3dpbd_app1.swc'
    raw = raw_dir / f'{name}.v3dpbd_app1.swc'
    try:
        with HidePrint():
...
if __name__ == '__main__':
    ...
    tab.to_csv(wkdir / 'eval_app1.csv')
